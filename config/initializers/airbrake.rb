...
Airbrake.configure do |c|
  ...
  c.blocklist_keys = [/password/i, /authorization/i, /email/i, /email_verification_code/i, /redirect_uri/i, /nonce/i, /secret/i, /token/i, /_key/i, /crypt/i, /salt/i, /certificate/i, /otp/i, /ssn/i]
